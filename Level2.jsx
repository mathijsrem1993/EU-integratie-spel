  ...
  return (
    <div className="w-full h-screen bg-gradient-to-b from-stone-100 to-stone-50 relative overflow-hidden flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center relative">
        ...
        <div className="absolute bottom-[140px] left-[740px] z-10">
        ...
        <div className="absolute bottom-0 left-0 w-full z-20 pointer-events-none">
          <svg className="w-full h-full" viewBox="0 0 1200 700" preserveAspectRatio="xMidYMid slice">
            ...
            <rect x="300" y="540" width="600" height="45" fill="#4A3428" />
            {/* Closed front panel */}
            <rect x="360" y="585" width="520" height="80" fill="#3A2418" />
            {/* Desktop surface */}
            <rect x="305" y="538" width="590" height="6" fill="#5A4838" />
            
            {/* Desk items on top of desk */}
            {/* Leather folder - left */}
            <rect x="350" y="505" width="90" height="65" fill="#6B4423" rx="2" />
            <rect x="355" y="510" width="80" height="55" fill="#8B5A3C" />
            <line x1="395" y1="510" x2="395" y2="565" stroke="#6B4423" strokeWidth="2" />
            
            {/* Report - center BETWEEN David and Draghi - LIGHT BLUE */}
            <rect x="520" y="500" width="110" height="75" fill="#B8D4E8" stroke="#9BB8D0" strokeWidth="2" />
            <rect x="525" y="505" width="100" height="65" fill="#D0E4F5" />
            <text x="575" y="525" fontSize="7" fontWeight="bold" fill="#1a1a1a" textAnchor="middle">The future of</text>
            <text x="575" y="535" fontSize="7" fontWeight="bold" fill="#1a1a1a" textAnchor="middle">European</text>
            <text x="575" y="545" fontSize="7" fontWeight="bold" fill="#1a1a1a" textAnchor="middle">competitiveness</text>
            <text x="575" y="560" fontSize="6" fill="#666" textAnchor="middle">Mario Draghi</text>
            
            {/* Fountain pen - right */}
            <rect x="720" y="530" width="6" height="35" fill="#2C2C28" transform="rotate(-15 723 547)" />
            <circle cx="723" cy="530" r="3" fill="#C0A060" />
            <path d="M 721 562 L 723 567 L 725 562" fill="#1A1A18" />
            
            {/* Nameplate - Mario Draghi - right side */}
            <rect x="750" y="515" width="140" height="28" fill="#C19A6B" stroke="#8B7355" strokeWidth="2" />
            <rect x="754" y="519" width="132" height="20" fill="#D4AF37" />
            <text x="820" y="532" fontSize="10" fontWeight="bold" fill="#1F2937" textAnchor="middle">Mario Draghi</text>
          </svg>
        </div>
