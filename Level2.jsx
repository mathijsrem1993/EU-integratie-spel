  ...
  return (
    <div className="w-full h-screen bg-gradient-to-b from-stone-100 to-stone-50 relative overflow-hidden flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center relative">
        ...
        <div className="absolute bottom-[40px] left-[920px] z-10">
        ...
        <div className="absolute bottom-0 left-0 w-full z-20 pointer-events-none">
          <svg className="w-full h-full" viewBox="0 0 1200 700" preserveAspectRatio="xMidYMid slice">
            ...
            <rect x="300" y="380" width="600" height="45" fill="#4A3428" />
            {/* Closed front panel */}
            <rect x="360" y="425" width="520" height="80" fill="#3A2418" />
            {/* Desktop surface */}
            <rect x="305" y="378" width="590" height="6" fill="#5A4838" />
            
            {/* Desk items on top of desk */}
            {/* Leather folder - left */}
            <rect x="350" y="345" width="90" height="65" fill="#6B4423" rx="2" />
            <rect x="355" y="350" width="80" height="55" fill="#8B5A3C" />
            <line x1="395" y1="350" x2="395" y2="405" stroke="#6B4423" strokeWidth="2" />
            
            {/* Report - center BETWEEN David and Draghi - LIGHT BLUE */}
            <rect x="520" y="340" width="110" height="75" fill="#B8D4E8" stroke="#9BB8D0" strokeWidth="2" />
            <rect x="525" y="345" width="100" height="65" fill="#D0E4F5" />
            <text x="575" y="365" fontSize="7" fontWeight="bold" fill="#1a1a1a" textAnchor="middle">The future of</text>
            <text x="575" y="375" fontSize="7" fontWeight="bold" fill="#1a1a1a" textAnchor="middle">European</text>
            <text x="575" y="385" fontSize="7" fontWeight="bold" fill="#1a1a1a" textAnchor="middle">competitiveness</text>
            <text x="575" y="400" fontSize="6" fill="#666" textAnchor="middle">Mario Draghi</text>
            
            {/* Fountain pen - right */}
            <rect x="720" y="370" width="6" height="35" fill="#2C2C28" transform="rotate(-15 723 387)" />
            <circle cx="723" cy="370" r="3" fill="#C0A060" />
            <path d="M 721 402 L 723 407 L 725 402" fill="#1A1A18" />
            
            {/* Nameplate - Mario Draghi - right side */}
            <rect x="750" y="355" width="140" height="28" fill="#C19A6B" stroke="#8B7355" strokeWidth="2" />
            <rect x="754" y="359" width="132" height="20" fill="#D4AF37" />
            <text x="820" y="372" fontSize="10" fontWeight="bold" fill="#1F2937" textAnchor="middle">Mario Draghi</text>
          </svg>
        </div>
                  ...
                  <div className="flex gap-2 items-center">
                    ...
                    <div 
                      ...
                      className={`w-32 h-8 border-2 rounded flex items-center justify-center transition-all ${
                        ...
                        bottomRightCell ? 'border-green-500 bg-green-50' :
                        'border-gray-400 bg-gray-50 hover:border-blue-300 hover:bg-blue-50'
                      }`}
                    >
                      {bottomRightCell && (
